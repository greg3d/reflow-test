...
type WithoutLoadingState<IView extends ViewInterface<any, any, any>> = Omit<IView['input'][keyof IView['input']], 'loadingStatusState'>;

export interface Task2<IView extends ViewInterface<any, any, any>> {
    key: string,
    thread: () => Promise<WithoutLoadingState<IView>>,
    cb: (result: WithoutLoadingState<IView>) => void
}
...
export class Deferred2<IView extends ViewInterface<any, any, any>> {
    ...
    state: Record<IView['input'][keyof IView['input']], any>;
